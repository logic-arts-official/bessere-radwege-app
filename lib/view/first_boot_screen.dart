      ...
      body: Center(
        ...
        child: Column(
            ...
            children: [
              ...
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Text('Wir wollen mit Bewegungsdaten die Radwege analysieren und so bessere Wege für alle schaffen.',
                    style: Theme.of(context).textTheme.bodyMedium,
                ),
              ),
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Text('Dafür werden deine Bewegungsdaten und die Daten des Beschleunigungssensors auf dem Handy gesammelt und anonymisiert auf den Server hochgeladen.',
                  style: Theme.of(context).textTheme.bodyMedium,
                ),
              ),
              CheckboxListTile(
